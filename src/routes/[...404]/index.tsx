...
// Catch-all route: renders our branded 404 for ANY unmatched path.
// This is what makes the custom 404 show up in `dev` / `preview` (the dedicated
// `404.tsx` is only used for the static `404.html` in production builds).
